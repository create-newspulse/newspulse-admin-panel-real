...
const PollEditor = () => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (data.question && data.options) {
                ...
                toast.success('Γ£¿ AI generated a poll!');
            }
            else {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const data = await res.json();
            if (data.success) {
                toast.success('Γ£à Poll created');
