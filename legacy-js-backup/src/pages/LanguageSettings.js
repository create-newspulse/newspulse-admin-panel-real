...
// ≡ƒôü src/pages/LanguageSettings.tsx
import { useState } from 'react';
import { useLanguage } from '../context/LanguageContext';
// Γ£à Final Supported Language List (Only 3)
const supportedLanguages = [
    { name: 'Gujarati', label: '≡ƒç«≡ƒç│ α¬ùα½üα¬£α¬░α¬╛α¬ñα½Ç (Gujarati)', code: 'gu-IN' },
    { name: 'Hindi', label: '≡ƒç«≡ƒç│ αñ╣αñ┐αñ¿αÑìαñªαÑÇ (Hindi)', code: 'hi-IN' },
    { name: 'English', label: '≡ƒç«≡ƒç│ English (English)', code: 'en-IN' },
];
export default function LanguageSettings() {
    ...
    const handleSave = () => {
        ...
        alert(`Γ£à Language set to ${tempSelected}`);
    };
