    ...
    useEffect(() => {
        const fetchDiagnostics = async () => {
            try {
                ...
                console.error(err);
                setError("Γ¥î Failed to load diagnostics.");
            }
        };
        fetchDiagnostics();
