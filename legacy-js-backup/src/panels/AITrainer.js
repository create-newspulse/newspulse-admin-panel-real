...
export default function AITrainer() {
    ...
    const retrainNow = async () => {
        ...
        try {
            ...
            alert(`Γ£à ${res.message || 'Retraining triggered.'}`);
            // Optionally trigger context refresh (e.g., refetch training info)
        }
        catch (err) {
            console.error('Γ¥î Retrain failed:', err);
            alert('Γ¥î Training failed: ' + (err.message || 'Unknown error'));
        }
        finally {
    ...
    const activateFullTrainer = async () => {
        ...
        try {
            ...
            alert(`≡ƒº¼ ${res.message || 'Full AI Trainer activated.'}`);
            // Optionally trigger context refresh
        }
        catch (err) {
            console.error('Γ¥î Activation error:', err);
            alert('Γ¥î Activation failed: ' + (err.message || 'Unknown error'));
        }
        finally {
            setActivating(false);
        }
