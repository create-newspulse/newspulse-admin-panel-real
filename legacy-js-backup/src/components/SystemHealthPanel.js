...
export default function SystemHealthPanel() {
    ...
    const latency = typeof env?.latencyMs === 'number' ? `${Math.round(env.latencyMs)}ms` : 'ΓÇö';
    useEffect(() => {
        let mounted = true;
        let timer;
        const pull = async () => {
