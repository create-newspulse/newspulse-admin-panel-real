...
export function ThemeToggle() {
    ...
    return (_jsx("button", { type: "button", onClick: () => setIsDark(v => !v), className: "px-3 py-2 rounded-lg text-sm font-medium bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200 hover:bg-slate-300 dark:hover:bg-slate-600", "aria-label": "Toggle theme", title: "Toggle theme", children: isDark ? '≡ƒîÖ Dark' : 'ΓÿÇ∩╕Å Light' }));
}
