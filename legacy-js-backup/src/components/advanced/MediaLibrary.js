...
export default function MediaLibrary() {
    ...
    async function handleUpload(e) {
        ...
        try {
            ...
            alert('Upload failed ΓÇö check console');
        }
        finally {
            setUploading(false);
            e.target.value = '';
    ...
    async function generateAIAlt(item) {
        ...
        try {
            ...
            // simulate
            const simulated = `Photo of ${item.filename || 'an image'} ΓÇö auto-generated by AI`;
