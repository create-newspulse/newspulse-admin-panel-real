...
// ≡ƒô¥ ENTERPRISE STORY MANAGER - Advanced News Editorial Suite
...
const EnterpriseStoryManager = () => {
    ...
    const [storyTitle, setStoryTitle] = useState({
        ...
        hi: 'αñ¼αÑìαñ░αÑçαñòαñ┐αñéαñù: αñ«αñ╣αññαÑìαñ╡αñ¬αÑéαñ░αÑìαñú αñ╡αñ┐αñòαñ╛αñ╕ αñòαñ╛ αñûαÑüαñ▓αñ╛αñ╕αñ╛',
        gu: 'α¬¼α½ìα¬░α½çα¬òα¬┐α¬éα¬ù: α¬«α½üα¬ûα½ìα¬» α¬╡α¬┐α¬òα¬╛α¬╕ α¬╕α¬╛α¬«α½ç α¬åα¬╡α½ìα¬»α½ï'
    });
    const [storyContent, setStoryContent] = useState({
        en: 'In a significant development that has captured national attention...',
        hi: 'αñÅαñò αñ«αñ╣αññαÑìαñ╡αñ¬αÑéαñ░αÑìαñú αñ╡αñ┐αñòαñ╛αñ╕ αñ«αÑçαñé αñ£αñ┐αñ╕αñ¿αÑç αñ░αñ╛αñ╖αÑìαñƒαÑìαñ░αÑÇαñ» αñºαÑìαñ»αñ╛αñ¿ αñåαñòαñ░αÑìαñ╖αñ┐αññ αñòαñ┐αñ»αñ╛ αñ╣αÑê...',
        gu: 'α¬Åα¬ò α¬«α¬╣α¬ñα½ìα¬╡α¬¬α½éα¬░α½ìα¬ú α¬╡α¬┐α¬òα¬╛α¬╕α¬«α¬╛α¬é α¬£α½çα¬úα½ç α¬░α¬╛α¬╖α½ìα¬ƒα½ìα¬░α½Çα¬» α¬ºα½ìα¬»α¬╛α¬¿ α¬åα¬òα¬░α½ìα¬╖α½ìα¬»α½üα¬é α¬¢α½ç...'
    });
    ...
    const getLanguageDisplay = (lang) => {
        switch (lang) {
            case 'en': return { name: 'English', flag: '≡ƒç║≡ƒç╕' };
            case 'hi': return { name: 'αñ╣αñ┐αñéαñªαÑÇ', flag: '≡ƒç«≡ƒç│' };
            case 'gu': return { name: 'α¬ùα½üα¬£α¬░α¬╛α¬ñα½Ç', flag: '≡ƒç«≡ƒç│' };
        }
    };
