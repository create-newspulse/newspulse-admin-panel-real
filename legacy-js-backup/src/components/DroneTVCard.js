...
// Γ£à Color map for tags
const moodTagColors = {
    '≡ƒºÿ Calm': 'bg-blue-100 text-blue-800',
    '≡ƒî▓ Nature': 'bg-green-100 text-green-800',
    '≡ƒÅ₧∩╕Å Scenic': 'bg-indigo-100 text-indigo-800',
    '≡ƒÜü Aerial': 'bg-gray-100 text-gray-800',
    '≡ƒÄ╡ Ambient': 'bg-purple-100 text-purple-800',
};
