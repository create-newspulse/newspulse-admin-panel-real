...
const ArticleSchema = new mongoose.Schema({
  ...
  sourceLanguage: { type: String, enum: LANG_ENUM, default: null, index: true },
  translationGroupId: { type: String, default: '', trim: true, index: true },
  baseArticleId: { type: mongoose.Schema.Types.ObjectId, ref: 'Article', default: null, index: true },
  translationStatus: { type: String, default: '', trim: true, index: true },
  translationError: { type: String, default: '', trim: true },
  translationUpdatedAt: { type: Date, default: null },
