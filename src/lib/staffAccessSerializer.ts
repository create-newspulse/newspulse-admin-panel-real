...
const SPECIAL_RIGHT_BACKEND_BY_LOCAL: Record<string, string> = {
  ...
  view_marketing: 'marketing_view',
  view_advertisers: 'marketing_view_advertisers',
  create_advertiser: 'marketing_create_advertiser',
  edit_advertiser: 'marketing_edit_advertiser',
  manage_contacts: 'marketing_manage_contacts',
  log_sales_activity: 'marketing_log_sales_activity',
  manage_followups: 'marketing_manage_followups',
  view_proposals: 'marketing_view_proposals',
  create_proposal: 'marketing_create_proposal',
  edit_proposal: 'marketing_edit_proposal',
  view_partnerships: 'marketing_view_partnerships',
  manage_partnerships: 'marketing_manage_partnerships',
  assign_sales_owner: 'marketing_assign_sales_owner',
  approve_proposal: 'marketing_approve_proposal',
  approve_marketing_discount: 'marketing_approve_discount',
  mark_deal_won: 'marketing_mark_deal_won',
  mark_deal_lost: 'marketing_mark_deal_lost',
  send_to_ads_manager: 'marketing_send_to_ads_manager',
  manage_internal_rate_card: 'marketing_manage_internal_rate_card',
  delete_marketing_record: 'marketing_delete_record',
  view_audience_growth: 'marketing_view_audience_growth',
  view_promotions: 'marketing_view_promotions',
  create_promotion: 'marketing_create_promotion',
  edit_promotion: 'marketing_edit_promotion',
  manage_promotion_calendar: 'marketing_manage_promotion_calendar',
  create_utm_links: 'marketing_create_utm_links',
  log_promotion_activity: 'marketing_log_promotion_activity',
  view_growth_goals: 'marketing_view_growth_goals',
  manage_growth_goals: 'marketing_manage_growth_goals',
  manage_utm_presets: 'marketing_manage_utm_presets',
  manage_channel_settings: 'marketing_manage_channel_settings',
  archive_promotion: 'marketing_archive_promotion',
  delete_promotion: 'marketing_delete_promotion',
  manage_marketing_settings: 'marketing_manage_settings',
  view_marketing_performance: 'marketing_view_performance',
  view_campaign_performance: 'marketing_view_campaign_performance',
  view_promotion_performance: 'marketing_view_promotion_performance',
  view_renewals: 'marketing_view_renewals',
  manage_renewals: 'marketing_manage_renewals',
  create_campaign_report: 'marketing_create_campaign_report',
  view_growth_performance: 'marketing_view_growth_performance',
  view_marketing_deal_values: 'marketing_view_deal_values',
  approve_campaign_report: 'marketing_approve_campaign_report',
  export_marketing_performance: 'marketing_export_performance',
  manage_renewal_settings: 'marketing_manage_renewal_settings',
  delete_campaign_report: 'marketing_delete_campaign_report',
  delete_renewal_record: 'marketing_delete_renewal_record',
