...
const FounderControlPanel = () => {
    ...
    const handleLockdown = async () => {
        ...
        try {
            ...
            if (json.success ?? true)
                notify.success('🚨 Emergency Lockdown Triggered');
            else
                notify.error('❌ Lockdown request failed');
        }
        catch (error) {
    ...
    const handleReactivate = async () => {
        ...
        try {
            ...
            if (json.success ?? true)
                notify.success('✅ System reactivated successfully');
            else
                notify.error('❌ Failed to reactivate system');
        }
        catch (err) {
