...
const VoicePlayer = ({ text, language }) => {
    ...
    return (_jsx("button", { onClick: handlePlay, className: `px-3 py-1 text-sm rounded bg-pink-600 text-white hover:bg-pink-700 transition ${speaking ? 'opacity-60' : ''}`, disabled: speaking, children: speaking ? '🔊 Playing...' : '▶️ Listen' }));
};
