...
export default function AITrainerPanel() {
  ...
  const fetchTrainingInfo = async () => {
    try {
      console.log('📡 Fetching: /api/system/ai-training-info');
      const res = await axios.get('/api/system/ai-training-info');
  ...
  const handleRetrainNow = async () => {
    ...
    try {
      ...
      const res = await axios.put('/api/system/ai-training-info', updatedData);
      if (res.data?.success) {
  ...
  const handleSubmitFeedback = async () => {
    ...
    setIsSubmitting(true);
    try {
      await axios.post('/api/system/ai-trainer/log', {
        command: 'feedback',
