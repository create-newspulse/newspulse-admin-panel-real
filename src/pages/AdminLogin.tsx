    ...
    <div className="min-h-screen flex justify-center items-center bg-gray-50">
      <div className="text-center space-y-4">
        ...
        <div className="space-y-2">
          <Link to="/login" className="inline-block bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded">Go to Login</Link>
          <Link to="/auth" className="block text-blue-600 underline text-sm">Advanced Auth & MFA</Link>
        </div>
      </div>
    </div>
  );
