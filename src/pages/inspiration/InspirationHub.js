...
const InspirationHub = () => {
    ...
    return (_jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10", children: [_jsx("h1", { className: "text-3xl font-bold text-slate-900 dark:text-white mb-10", children: "\uD83C\uDF04 Inspiration Hub" }), _jsxs(SectionBlock, { title: "\uD83D\uDE81 DroneTV \u2013 Scenic Nature Relaxation (Auto Embed)", children: [_jsx("div", { className: "aspect-video w-full rounded overflow-hidden border border-gray-300 shadow", children: _jsx("iframe", { src: "https://www.youtube.com/embed/YVYNY6ez_uw", title: "DroneTV", allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", allowFullScreen: true, className: "w-full h-full" }) }), _jsx("p", { className: "text-sm text-gray-500 mt-2 text-center", children: "\u2705 Auto embed from YouTube. For peaceful and safe viewing." })] }), _jsxs(SectionBlock, { title: "\u2728 Daily Wonders \u2013 Uplifting Visual Quotes", children: [_jsx("div", { className: "aspect-video w-full rounded overflow-hidden border-2 border-yellow-400 shadow-lg bg-yellow-50 dark:bg-yellow-900/30 flex flex-col items-center justify-center", children: _jsx("iframe", { src: "https://www.youtube.com/embed/qtYGQT-9Sc4", title: "Daily Wonders \u2013 Uplifting Visual Quotes", allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", allowFullScreen: true, className: "w-full h-full", style: { minHeight: 240 } }) }), _jsx("p", { className: "text-sm text-yellow-700 dark:text-yellow-200 mt-2 text-center", children: "\uD83C\uDF1F Auto embed from YouTube. Uplifting visual quotes for your day." })] }), _jsxs(SectionBlock, { title: "\u270D\uFE0F Embed Your Own Video (Manual)", children: [_jsx("textarea", { rows: 4, className: "w-full p-3 rounded border border-gray-300 text-sm font-mono", placeholder: "<iframe ...></iframe>", value: customEmbed, onChange: (e) => setCustomEmbed(e.target.value) }), _jsx("button", { className: "mt-3 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-500", onClick: () => setEmbedPreview(customEmbed), children: "\u25B6\uFE0F Preview Embed" }), embedPreview && (_jsx("div", { className: "mt-6 aspect-video w-full rounded overflow-hidden border border-blue-500 shadow", children: (() => {
                        ...
                        })() }))] }), _jsx("p", { className: "text-xs text-center text-gray-400 mt-10 border-t pt-4", children: "\uD83D\uDCDC All videos are embedded from YouTube. We do not store, modify, or monetize any external content." })] }));
};
