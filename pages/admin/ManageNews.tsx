...
const ManageNews: React.FC = () => {
  ...
  const [anchorSource, setAnchorSource] = useState<NewsItem | null>(null);
  ...
  return (
    ...
    <div className="p-0">
                  ...
                  <td className="p-2 border flex gap-2">
                    {editingId === item._id ? (
                      ...
                      <>
                        ...
                        <button onClick={() => { setAnchorSource(item); setAnchorOpen(true); }} className="bg-indigo-600 text-white px-3 py-1 rounded">Listen</button>
      ...
      <AiAnchorPlayer open={anchorOpen} onClose={() => setAnchorOpen(false)} source={anchorSource} />
    </div>
    </AdminShell>
  );
};
